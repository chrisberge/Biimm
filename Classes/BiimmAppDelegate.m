...
@implementation BiimmAppDelegate
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"Biimm.sqlite"];
	...
	defaultStorePath = [[NSBundle mainBundle] pathForResource:@"Biimm" ofType:@"sqlite"];
