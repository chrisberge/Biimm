...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:@"demande-estimation.png"];
    ...
    image = [UIImage imageNamed:@"notre-agence.png"];
...
- (void) buttonPushed:(id)sender
{
    ...
    AgenceModalView *agenceModalView = [[[AgenceModalView alloc] init] autorelease];
    agenceModalView.delegate = self;
    
    AgenceModalVendre *agenceModalVendre = [[[AgenceModalVendre alloc] init] autorelease];
    agenceModalVendre.delegate = self;
    
    AgenceModalEstimation *agenceModalEstimation = [[[AgenceModalEstimation alloc] init] autorelease];
    agenceModalEstimation.delegate = self;
    
    AgenceModalPresAkios *agenceModalPresAkios = [[[AgenceModalPresAkios alloc] init] autorelease];
