...
- (void)viewDidLoad
{
    ...
    //TABLE VIEW
    myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 50, 320, 350) style:UITableViewStylePlain];
...
- (void) searchTableView:(NSString *)theText {
	...
	BiimmAppDelegate *appDelegate = (BiimmAppDelegate *)[[UIApplication sharedApplication] delegate];
