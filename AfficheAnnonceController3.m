...
- (void)viewDidLoad
{
    ...
    //TEL
    NSString *texte = [lAnnonce valueForKey:@"tel_agence"];
    
    NSString *phone = [NSString stringWithFormat: @"%@ %@ %@ %@ %@",
                       [texte substringWithRange:NSMakeRange(0,2)],
                       [texte substringWithRange:NSMakeRange(2,2)],
                       [texte substringWithRange:NSMakeRange(4,2)],
                       [texte substringWithRange:NSMakeRange(6,2)],
                       [texte substringWithRange:NSMakeRange(8,2)]
                       ];
    
    UITextView *tel = [[UITextView alloc] initWithFrame:CGRectMake(15, nextY, 150, 20)];
    tel.text = [NSString stringWithFormat:@"Tél : %@", phone];
...
- (void) buttonEcrivez:(id)sender
{
    ...
    NSString *texte = [lAnnonce valueForKey:@"email_agence"];
...
- (void) buttonFavoris:(id)sender
{
    ...
    NSDictionary *recordAnnonce = [[NSDictionary alloc] initWithObjectsAndKeys:
                                   ...
                                   [lAnnonce valueForKey:@"tel_agence"], @"tel_agence",
                                   [lAnnonce valueForKey:@"email_agence"], @"email_agence",
                                   nil];
