...
@implementation AgenceModalVendre
...
- (void)viewDidLoad
{
    ...
    //BANDEAU VENDRE
    UIImageView *bandeauFavoris = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bandeau-vendre-bien.png"]];
    ...
    //PRIX
    UILabel *labelPrix = [[UILabel alloc] initWithFrame:CGRectMake(30, 420, 150, 30)];
    labelPrix.backgroundColor = [UIColor clearColor];
    labelPrix.text = @"PRIX:";
    [scrollView addSubview:labelPrix];
    [labelPrix release];
    
    prixTF = [[UITextField alloc] initWithFrame:CGRectMake(30, 450, 250, 30)];
    prixTF.borderStyle = UITextBorderStyleRoundedRect;
    prixTF.keyboardType = UIKeyboardTypeNumberPad;
    prixTF.delegate = self;
    [scrollView addSubview:prixTF];
    [prixTF release];
    
    //ADRESSE
    UILabel *labelAdresse = [[UILabel alloc] initWithFrame:CGRectMake(30, 480, 150, 30)];
    ...
    //CODE POSTAL
    UILabel *labelCodePostal = [[UILabel alloc] initWithFrame:CGRectMake(30, 540, 150, 30)];
    ...
    //VILLE
    UILabel *labelVille = [[UILabel alloc] initWithFrame:CGRectMake(30, 600, 150, 30)];
...
- (void)done:(id)sender
{
    [self.delegate agenceModalVendreDidFinish:self];
}
